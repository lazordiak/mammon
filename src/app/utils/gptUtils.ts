...
export const messageChatGpt = async (
  ...
  switch (conversationState) {
    ...
    case 2:
      ...
      break;
    case 3:
      dynamicPrompt = `Based on their response, question them further. Your goal is to use this information to determine a task they should perform in exchange for your blessing. Do not actually assign them this task yet. Respond in 75 words or left.`;
      break;
    case 4:
