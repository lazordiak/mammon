...
export const messageChatGpt = async (
  ...
  const response = await openAiInstance!.chat.completions.create({
    model: "gpt-4o-mini",
    messages: [
      { role: "system", content: promptToSelect },
      {
        role: "user",
        content: userMessage,
      },
