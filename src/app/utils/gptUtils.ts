...
export const createOpenAiInstance = () => {
  openAiInstance = new OpenAI({
    ...
    apiKey:
      "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",
  });
};
